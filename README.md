...
Note that some tips:
1. This data set was initially built for the empirical study aligned with the research on the coevolution of social communities and behaviors working with Zachary Neal and Wolfgang Banzhaf. Created by Honglin Bao, 2019 summer. However, we found that this empirical data is not proper aligned with our theoretical model. So, we only submitted the theoretical work, and it is currently under review. We release this data set to the public for research/education use.
